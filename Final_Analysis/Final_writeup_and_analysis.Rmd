...
```{r k values post-hoc t-tests, include=F, results='hide', error=FALSE, warning=FALSE}
...
The replication attempt was reasonably powered, yet 

*Likely not due to lack of power (effect size really small and if anything- in the opposite direction)
*Not because of "simple" sample differences
*Can not really be accounted for by differences between \$U.S and \$H.K, but possible
*Culture?
*Not including cognitive testing?
